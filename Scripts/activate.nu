...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\valer\OneDrive\Документы\study\web auto\lesson3\hw3\selenium'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\valer\OneDrive\Документы\study\web auto\lesson3\hw3\selenium\Scripts\deactivate.nu'
